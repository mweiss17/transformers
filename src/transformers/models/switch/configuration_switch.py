...
class SwitchConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers.SwitchModel`.
    It is used to instantiate a Switch model according to the specified arguments,
    ...
    Arguments:
        vocab_size (:obj:`int`, `optional`, defaults to 32128):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers.SwitchModel`.
